...
def find_even_index(arr):
    """Identify the index N where the sum of the integers to the left of N is
    ...
    :rtype: int
    :return: The index where the sum of items on either sides are equal
    """

    # If the sum of all indexes equal 0 the job is done as that would be equal
    # to the left side of index 0 which is None, or 0
    if not sum(arr):
        return 0
    ...
    # If we do not find an index that fits the rules, then you will return -1
    return -1
